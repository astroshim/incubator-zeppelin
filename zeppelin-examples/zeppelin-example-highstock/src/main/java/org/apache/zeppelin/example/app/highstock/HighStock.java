 ...
 */
package org.apache.zeppelin.example.app.highstock;
 ...
 * TableData for input
 */
public class HighStock extends Application {
  private final Logger logger = LoggerFactory.getLogger(HighStock.class);

  InterpreterResult result;

  public HighStock(ApplicationContext context) {
    super(context);
  }
  ...
  public void run(ResourceSet resources) throws ApplicationException, IOException {
    ...
    println(String.format(
        "<div id=\"highstock_%s\" style=\"height:400px\"><svg></svg></div>",
        context().getApplicationInstanceId()));
    // write js
    printResourceAsJavascript("example/app/highstock/highstock.js");
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    InputStream ins = ClassLoader.getSystemResourceAsStream(
        "example/app/highstock/highstock_mockdata.txt");
